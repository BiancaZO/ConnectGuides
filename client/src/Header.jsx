...
export default function Header() {
  ...
  return (
    <div>
      <header className="p-1 flex flex-col md:flex-row justify-between bg-white bg-opacity-30 backdrop-blur-lg">
        ...
        <div className="flex items-center gap-4 md:gap-8 border border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300 mt-4 md:mt-0 flex-grow md:flex-grow-0">
          <input
            type="text"
          ...
          />
          <button className="bg-blue text-white p-2 rounded-full" onClick={handleSearch} style={{ width: '40px', height: '40px' }}>
        ...
        <div className="flex items-center gap-2 border-gray-300 rounded-full py-2 px-4 mt-4 md:mt-0">

...
//   beforeEach(() => {
//     // Adjust URL to your actual login endpoint with the full URL
//     cy.request('POST', 'http://localhost:5173/api/login', {  // Make sure to use the correct port and endpoint
//       email: 'r@email.com',
//       password: '12345678'
//     }).then((resp) => {
...
//     });
//     // Adjust the URL to the form page you want to test
//     cy.visit('http://localhost:5173/guideServiceForm'); 
//   });
